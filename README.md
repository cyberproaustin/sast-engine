...
**Measured, not asserted.** 95 corpora are scored on every test run — vulnerable, safe,
...
What has been measured: 95 corpora in this repository score precision 1.00 and recall
