...
PY_CORPORA := flask-command-injection flask-container-update flask-sql-injection flask-class-views python-tls-verification flask-upload-type flask-cookie-attributes flask-misconfiguration flask-template-injection
